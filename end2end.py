...
# Create TensorFlow Datasets for training and test sets
...
with open(log_file, "w") as f:
    for epoch in range(epochs):
        ...
        f.write(f"Epoch {epoch + 1}/{epochs} - Train Loss: {loss:.6f} - Test Loss: {test_loss:.6f}\n")
        print(f"Epoch {epoch + 1}/{epochs} - Train Loss: {loss:.6f} - Test Loss: {test_loss:.6f}")
